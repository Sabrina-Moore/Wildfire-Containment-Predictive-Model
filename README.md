...
## Methods
Cleaning: 
- [ ] Trimmed whitespace trims
- [ ] Removed rows with missing values in key categories
- [ ] Performed type coercion on timestamps
- [ ] Removed duplicate rows

Modeling: 
- [ ] Training supervised machine learning regression models to forecast containment time
## Results
...
My code was run using .py files and not ipynb notebooks. You may want to convert the code based on your preferences. 
...
Create a virtual environment to run code
